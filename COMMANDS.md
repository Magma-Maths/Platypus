...
<!-- The following help text block is automatically generated by `scripts/update-commands-md` from `platypus subtree --help`. Do not edit manually. -->
...
<!-- The following help text block is automatically generated by `scripts/update-commands-md` from `platypus svn --help`. Do not edit manually. -->
